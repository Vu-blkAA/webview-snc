...
import { COMPANY_INFORMATION, LIST_COLOR, TEMPLATE, information } from "./contants";
...
function App() {
  ...
  const handleGetTemplate = () => {
    API.get("https://carz-dev.libertycarz.com/temporary/1703646630430-IIZaHx?Policy=eyJTdGF0ZW1lbnQiOlt7IlJlc291cmNlIjoiaHR0cHM6Ly9jYXJ6LWRldi5saWJlcnR5Y2Fyei5jb20vdGVtcG9yYXJ5LzE3MDM2NDY2MzA0MzAtSUlaYUh4KiIsIkNvbmRpdGlvbiI6eyJEYXRlTGVzc1RoYW4iOnsiQVdTOkVwb2NoVGltZSI6MTcwMzczMzAzMH19fV19&Key-Pair-Id=K10XLBJ27QHL3Y&Signature=j9Lvc5OlnE18FSzQfCg8a2tmBPo5p~a1~HfeMNFUGNfJ76TrjAQZMzJFyA-N2DDPIbDwIHGJLK9H1Qe0hr3h653vKZPxyhvugXU8qYok79PyhpvcCrOj8ZVuyKhLyvYzxpThlENz665Y2xCg5ESJyssuCi9mog-lg7q7jS-5w2EqF4MHBANE2D2lHXFcjzwzthcR1hc2UDLEwbNSyz-9hSPGx2gEIU3BIR-bnY-OE~zgXpAnKguuoE2WweJag-mhuENYoyEIpHM-VuqPlhUh9LojVDsQjHO42kb87e7NP0xt0-wgPbCE5bhH~KpFKuipN5HeWsZgvHEOBt~Ww5IkHQ__")
      .then((response) => {
          ...
          {parse(template.content, {
            replace: (domNode: any) => {
              if (domNode.attribs && domNode.attribs?.id) {
                ...
                if (
                  Object.keys(COMPANY_INFORMATION).includes(
                    domNode?.attribs?.id
                  )
                ) {
                  domNode.children = [
